...
module.exports = app => {
    ...
    app.get('/video/categorias/:categoria', (req, res) => {
        const categoria = req.params.categoria;
        console.log("busca por categoria",categoria);
        Videos.buscaPorCategoria(categoria, res);
    })

    app.get('/video/titulo/:titulo', (req, res) => {
        const titulo = req.params.titulo;
        console.log("busca por categoria",titulo);
        Videos.buscaPorTitulo(titulo, res);
    })
