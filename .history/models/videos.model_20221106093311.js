...
class videos {
    ...
    altera(id, valores, res) {
        ...
        const sql = `UPDATE videos v SET v.titulo="${valores.titulo}" AND v.url = "${valores.url}" AND v.descricao = "${valores.descricao}" AND v.categoriaId = ${valores.categoriaId} WHERE id = ${id};`
