class Tabelas {
    ...
    criarVideos() {
        const sql = 'CREATE TABLE IF NOT EXISTS Videos (id int NOT NULL AUTO_INCREMENT, titulo varchar(50), descricao varchar(60), url varchar(40), categoria varchar(20), PRIMARY KEY(id))'
