class Tabelas {
    ...
    criarVideos() {
        const sql = 'CREATE TABLE IF NOT EXISTS Videos (id int NOT NULL AUTO_INCREMENT, titulo varchar(100), descricao varchar(100), url varchar(100), categoriaId varchar(100), PRIMARY KEY(id), FOREIGN KEY(categoriaId) REFERENCES Categorias(id)))'
    ...
    criarCategorias() {
        const sql = 'CREATE TABLE IF NOT EXISTS Categorias (id int NOT NULL AUTO_INCREMENT, categoria varchar(100), PRIMARY KEY(id))'
